...
def load_goas_data(shapefile_path: Union[str, Path]) -> "gpd.GeoDataFrame":
    ...
    if not shapefile_path.exists():
        raise FileNotFoundError(
            ...
            "To set up the GOaS shapefile:\n\n"
            "Option 1 - Manual download (required — Marine Regions requires a registration form):\n"
            "    1. Visit: https://www.marineregions.org/downloads.php\n"
            "    2. Download: GOaS_v1_20211214.zip\n"
            f"    3. Extract to: {shapefile_path.parent}\n"
            "    4. Verify: python -m boldgenotyper.goas_downloader\n\n"
            "Option 2 - Skip geographic analysis:\n"
